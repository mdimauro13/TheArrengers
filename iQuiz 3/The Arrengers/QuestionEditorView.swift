...
let  salvataggio = saveData(name: "1. When did the French Revolution start?")
let  salvataggio1 = saveData(name: "2. When did the French Revolution end?")
                        ...
                        VStack {
                            ...
                            ForEach(folderCreation_array) { folder in
                                ZStack{
                                    ...
                                    NavigationLink("",destination:QuestionListView(saveDone: salvataggio, saveDone1: salvataggio1, saveDone2: salvataggio2, saveDone3: salvataggio3, saveDone4: salvataggio4),isActive: $showDetails).isDetailLink(false)
